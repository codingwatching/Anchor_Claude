...
--[[
  Shifts the array to the right n times, the last values are warped over to the become the first values of the array.
  Examples:
    array.rotate() -> nil
    array.rotate({}) -> {}
    array.rotate({1, 2, 3, 4}, 1) -> {4, 1, 2, 3}
    array.rotate({1, 2, 3, 4}, 3) -> {2, 3, 4, 1}
...
function array.rotate(t, n)
  ...
  t = array.reverse(t, 1, #t)
  t = array.reverse(t, 1, #t-n)
  t = array.reverse(t, #t-n+1, #t)
  return t
end
