...
function layout:layout_cut_left(v)
  ...
  return object():layout_lt(old_x1, self.y1, self.x1-old_x1, self.y2-self.y1)
end
...
function layout:layout_cut_top(v)
  ...
  return object():layout_lt(self.x1, old_y1, self.x2-self.x1, self.y1-old_y1)
end
