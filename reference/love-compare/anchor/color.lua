...
function color:color_mix2(i, c, weight)
  local i = i or 0
  local weight = weight or 1
  return object():color((weight*self[i].r + c.r*(1-weight)), (weight*self[i].g + c.g*(1-weight)), (weight*self[i].b + c.b*(1-weight)), (weight*self[i].a + c.a*(1-weight)), self.step, self.alpha_step)
end
