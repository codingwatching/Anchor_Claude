...
--[[
  Cancels a previously added action by tag.
  The action will be marked for removal and removed at the end of this frame, but will still run this frame.
--]]
function object:cancel_action(tag)
  table.insert(self.actions_marked_for_removal, tag)
end
...
--[[
  Cancels a previously added early action by tag.
  The early action will be marked for removal and removed at the end of this frame, but will still run this frame.
--]]
function object:cancel_early_action(tag)
  table.insert(self.early_actions_marked_for_removal, tag)
end
...
--[[
  Cancels a previously added late action by tag.
  The late action will be marked for removal and removed at the end of this frame, but will still run this frame.
--]]
function object:cancel_late_action(tag)
  table.insert(self.late_actions_marked_for_removal, tag)
end
...
--[[
  Returns true if this object has the given name, or if it is of the given type or class.
  Examples:
    ...
    player_instance:is(player)       -> true
--]]
function object:is(name_or_type_or_class)
  return self:class_is(name_or_type_or_class) or self.name == name_or_type_or_class or self.tags[name_or_type_or_class]
end
